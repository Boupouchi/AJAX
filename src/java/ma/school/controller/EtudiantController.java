    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (op.equals("Envoyer")) {
            ...
            response.sendRedirect("etudiantForm.jsp");
             ...
             int id = Integer.parseInt(request.getParameter("id"));
            RequestDispatcher rd= request.getRequestDispatcher("etudiantUpdate.jsp");
...
//    es.update(null);
    ...
    //response.sendRedirect("etudiantUpdate.jsp");
    ...
    protected void doUpdate(HttpServletRequest request, HttpServletResponse response)
        ...
        String nom = request.getParameter("nomOK");
            String prenom = request.getParameter("prenomOK");
             System.out.println("---------------------------------------------------");
    System.out.println("---------------------------------------------------");
        System.out.println(nom);      
        System.out.println(prenom);

            String ville = request.getParameter("villeOK");
            String date = request.getParameter("dateNaissanceOK");
    EtudiantService es = new EtudiantService();
