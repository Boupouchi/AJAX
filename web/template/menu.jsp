...
<ul>
    <li><a class="active" style="background-color: black0" href="#home">Home</a></li>
    <li><a href="etudiantForm.jsp">Gestion des etudiants</a></li>
    <li><a href="marqueForm.jsp">Gestion des marques</a></li>
    <li><a href="referenceForm.jsp">Gestion des references</a></li>
    ...
    <li><a href="machineByReferenceForm.jsp">Machines par reference</a></li>
     <li><a href="chart.jsp">Graphe de nombres de machines par marque</a></li>
</ul>